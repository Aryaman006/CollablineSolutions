            ...
            <div className="items-center container lg:pl-32 mx-auto px-8 py-16">
                ...
                <div className="pt-4 lg:col-span-3">
                    ...
                    <p className="text-gray-700 mb-8 text-justify">
                        ...
                        At Collabline Solutions, we can easily produce custom-built healthcare lists that are driven down to even the farthest-reaching niches. While many business services are limited with basic demographics, we offer our clients detailed fields of your target audience including Physician Data, emails, addresses.
                    </p>
