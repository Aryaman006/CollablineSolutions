    ...
    return (
        <div>
            ...
            <HeroSection
                ...
                subheading={<p className='text-justify'>When it comes to reaching the right technology customers, use the most effective and accurate technology users email lists offered by Collabline Solutions LLC. With more than 5 million records of technology users around the globe, you can choose our Technology users mailing list to grow your possibilities of communicating with IT professionals and other key decision-makers.</p>}
            />
