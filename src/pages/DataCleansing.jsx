    ...
    return (
        <div>
            ...
            <HeroSection
                ...
                subheading=
                {<div>
                    <p className='text-justify'>Having a list of accurate and clean data will streamline your multi-channel marketing campaigns, sales outreach, and newsletters. At Collabline Solutions, we brought a whole new way of updating and cleansing your email addresses with our best-in-class data cleansing services. It provides you a competitive edge over your marketers with an updated, accurate, and validated marketing database. This service allows you to upload bulk lists of the email addresses to check for bounces, wrong addresses, and duplicates which results in a clean and up-to-date list that is ready for use.</p>
                </div>}
            />
