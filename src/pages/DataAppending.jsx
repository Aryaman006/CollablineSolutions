                ...
                <div className="flex flex-wrap lg:flex-nowrap space-y-8 lg:space-y-0 lg:space-x-8">
                    ...
                    <div className="w-full lg:w-3/4 text-justify">
                        ...
                        <div>
                            ...
                            <p className='mb-4'>
                                At Collabline Solutions, we deliver the best database appending services to help businesses acquire, manage, and retain their clients with accurate customer records.
                            </p>
                            <p className='mb-4'>
                ...
                <div className="container mx-auto flex flex-col md:flex-row items-center justify-center max-w-screen-xl">
                    <div className="flex flex-col lg:flex-row items-center justify-center lg:space-x-8 w-full">
                        ...
                        <div className="lg:w-2/3 lg:text-left space-y-4 mb-8 lg:mb-0 text-justify">
                            <h2 className="text-xl font-bold text-black uppercase">Explore More Opportunities With Collabline Solutions Data Appending Services</h2>
                            ...
                            <div className="mt-8 text-justify">
                                <h3>Incomplete or inaccurate data can dampen your chances of running a successful email marketing campaign or closing a sales deal. Enhance the scope of your existing database and explore more opportunities with Collabline Solutions best data append services.</h3>
                ...
                <div className="max-w-4xl mx-auto p-6">
                    ...
                    <div className="bg-white shadow-md rounded-lg">
                        ...
                        <div className="faq-item border-b">
                            ...
                            >
                                <h3 className="font-semibold sm:text-base text-sm">
                                    WHY CHOOSE COLLABLINE SOLUTIONS B2B DATA APPEND SERVICES?
                                </h3>
                                <span className="text-xl">{expanded === 2 ? '-' : '+'}</span>
                            </div>
                            {expanded === 2 && (
                                <div className="px-6 pb-4">
                                    <p>Collabline Solutions offers a comprehensive and effective approach to data appending, with highly accurate data, industry-specific targeting, and personalized services tailored to your business needs.</p>
                                </div>
                            )}
                        </div>
